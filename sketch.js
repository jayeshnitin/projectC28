...
function setup() {
	...
	stoneObj=new stone(200,340,30); 
  stones = new body(stoneObj.body, {x:270, y:440})
...
function keyPressed(){
	...
	if (keyCode===32) {
		Matter.Body.setPosition(stoneObj.body, {x:270, y: 440});
	  stones.launch(stoneObj.body);
	}
